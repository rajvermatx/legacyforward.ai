        ...
        <div className="mx-auto max-w-5xl px-6 py-24">
          <div className="text-center mb-14">
            ...
            <p className="text-slate-300 max-w-2xl mx-auto leading-relaxed">
              AI-powered career navigation built for the AI era. Seven specialized agents
              working from your profile to give you clarity, direction, and a plan.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            <div className="bg-white/5 border border-white/10 rounded-xl p-7 hover:border-teal-500/40 transition-colors">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-xs font-bold bg-teal-500/20 text-teal-400 px-2 py-1 rounded uppercase tracking-wide">
                  16 chapters
                </span>
              </div>
              <h3 className="text-lg font-bold text-white mb-2">Your Personalized Career Book</h3>
              <p className="text-sm text-slate-400 leading-relaxed mb-4">
                A 16-chapter book written entirely about you — your background, your AI risk
                exposure, your roadmap, and your story. Generated by AI from your career snapshot,
                not a template.
              </p>
              <div className="space-y-1.5">
                {["Who You Are Today", "Where the World Is Going", "Your Personalized Roadmap", "Your Toolkit & Story"].map((part) => (
                  <div key={part} className="flex items-center gap-2 text-xs text-slate-400">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-7 hover:border-teal-500/40 transition-colors">
              ...
              <h3 className="text-lg font-bold text-white mb-2">Career Transition Map</h3>
              <p className="text-sm text-slate-400 leading-relaxed mb-4">
                Bridge Builder maps your existing skills to your target role line-by-line —
                showing where you already have a head start and exactly what gaps to close.
                Built for career changers, returners, and veterans entering new fields.
              </p>
              <div className="space-y-1.5">
                {["Skill overlap analysis", "Gap identification", "Bridge action plan", "Pre-populated from your profile"].map((item) => (
          ...
          <div className="text-center">
            <Link
              href="/app"
              className="inline-flex items-center gap-2 bg-teal-500 hover:bg-teal-600 text-white px-8 py-3.5 rounded-lg font-semibold transition-colors"
            >
              Explore the App
