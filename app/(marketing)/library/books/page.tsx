...
const bookDefs = [
  ...
  { section: "legacyforward-compendium", title: "LegacyForward: AI Beyond the Demo", desc: "How AI Actually Works in Enterprises — 62 chapters synthesizing all nine practitioner books into a single sequenced journey.", href: "/library/books/legacyforward-compendium", audience: "All Practitioners", color: "bg-violet-700" },
];
