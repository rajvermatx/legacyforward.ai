...
const bookDefs = [
  ...
  { section: "ai-beyond-the-demo-guide", title: "AI Beyond the Demo", desc: "How AI actually works in enterprises — the complete LegacyForward.ai framework for practitioners.", href: "/library/books/ai-beyond-the-demo-guide", audience: "All Roles", color: "bg-teal-600" },
