...
const staticPages = [
  ...
  "/library",
  "/library/books",
  "/library/books/building-agentic-ai-systems",
  "/library/books/leading-ai-real-enterprise",
  "/library/books/building-ai-products-that-ship",
  "/library/books/architecting-ai-real-enterprise",
  "/library/books/ai-for-analysts-and-qa",
  "/library/books/knowledge-graphs-enterprise-ai",
  "/library/books/the-stack-beneath-the-signal",
  "/library/books/ai-beyond-the-demo-guide",
  "/library/books/beyond-llms-large-concept-models",
