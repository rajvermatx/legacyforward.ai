...
const NAV_ITEMS = [
  ...
  { href: "/app/caii", label: "AI Impact Score", icon: (
    ...
    <aside className="hidden md:flex w-64 flex-col h-screen sticky top-0 bg-navy-900 border-r border-navy-800">
      ...
      <div className="p-3 border-t border-navy-800 space-y-2">
        ...
        {session?.user ? (
          ...
          <Link href="/app/login" className="px-3 py-2 text-xs text-teal-400 font-semibold hover:underline block">
            Sign in →
          </Link>
        )}
      </div>
