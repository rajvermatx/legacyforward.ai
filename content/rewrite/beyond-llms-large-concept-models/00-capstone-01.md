...
slug: "capstone-01"
description: "A compliance analyst at a global bank spends three weeks every quarter on a task that is fundamentally a semantic comparison problem. This capstone builds the system that does it in hours: SONAR encoding, cross-jurisdiction equivalence detection, contradiction detection by geometry, and a prioritized review report."
