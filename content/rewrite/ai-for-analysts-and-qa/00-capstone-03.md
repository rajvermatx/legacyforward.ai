...
slug: "capstone-03"
description: "Test suites decay: new features ship without tests, defect patterns repeat in the same modules, and nobody has time to reprioritize the regression suite. Build a system that generates, prioritizes, and maintains test suites by learning from your application's change history and defect data."
