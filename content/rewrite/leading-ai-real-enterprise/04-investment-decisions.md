...
Industry benchmarking on AI investment has become more reliable over the past two years as organizations move past early pilot spending into sustained programs. The following figures represent current market data for organizations with active AI programs.
...
2. For each, estimate: what would it be worth if this initiative succeeded completely? Use conservative, back-of-envelope figures.
