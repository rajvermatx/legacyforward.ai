...
The full document for most mid-sized organizations runs 8 to 15 pages. Longer is rarely better. The board presentation version is a further distillation of this document.
...
Use the readiness assessment from Chapter 5 (or conduct it fresh). The strategy should honestly characterize your organization's current readiness across data quality, technical infrastructure, governance maturity, and talent. Do not write a strategy that assumes readiness you do not have.
...
The portfolio section describes the AI initiatives your strategy will fund and execute. Five is a reasonable number for most mid-sized organizations — the right number is the number you can actually staff, govern, and measure with your available resources.
...
Use the risk framework from Chapter 6 adapted to your specific portfolio.
...
A strategy document is only as good as the discipline behind it. The frameworks in this capstone will not make a weak strategy strong. But they will make a good strategy visible — clear enough to fund, specific enough to execute, and honest enough to survive contact with reality.
