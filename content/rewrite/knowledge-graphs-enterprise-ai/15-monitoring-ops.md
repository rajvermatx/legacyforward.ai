...
slug: "monitoring-ops"
description: >-
  It is in production. Three things will wake you up at 3am if you do not
  monitor them: query latency spikes, graph size growth, and extraction
  pipeline failures. This chapter builds the full monitoring stack: key
  metrics dashboards, alert thresholds with severity levels, backup and
  disaster recovery, read replica routing, connection pool configuration,
  cost management, and an 8-issue runbook for your on-call team.
...
**Common causes and fixes:**
1. Data modeling issue: Break the supernode into subgroups (by time period or category).
