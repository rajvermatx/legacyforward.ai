...
slug: "orchestration"
description: "Single agents hit hard limits: context windows fill, specialization is impossible, one reasoning chain gives you one perspective. Multi-agent orchestration solves these problems — but introduces failure modes that don't exist in single-agent systems."
