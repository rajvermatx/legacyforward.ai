...
The evaluation dataset is the set of inputs against which the system's outputs are measured. Building a representative dataset is one of the highest-leverage investments a team can make.
...
Evaluation is most valuable when it runs automatically on every change:
