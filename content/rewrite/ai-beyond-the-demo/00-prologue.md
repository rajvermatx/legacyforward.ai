...
description: "Nine practitioner books, one sequenced journey. How to use this compendium — and why the sequencing is not arbitrary."
...
Not every reader needs to start at Chapter 1. Three recommended entry points:
...
Each chapter in this compendium is a synthesis — it draws on one or more of the nine source books and distills the most actionable content for a practitioner reading the full journey. For any topic where you need greater depth — more code, more worked examples, more decision trees — the source book is the right next step.
