...
description: "A supervisor decomposes goals and routes to specialized workers; workers execute within their domain and report back. This is the foundational multi-agent architecture — and getting it right is what separates reliable multi-agent systems from fragile ones."
