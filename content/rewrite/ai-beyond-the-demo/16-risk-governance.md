...
**Data risk:** The risk that the AI system was trained on or operates on data that is incorrect, biased, out of date, or governed in ways that make its AI use impermissible. Data risk is managed through the data governance practices from Chapter 5 and ongoing monitoring of training data quality.
...
**Regulatory and reputational risk:** The risk that AI system behavior violates regulations or causes public harm that damages organizational reputation. Regulatory risk is sector-specific — financial services AI faces different requirements than healthcare AI — but the management approach is consistent: know the relevant regulations, design for compliance from the start, and have a documented audit trail.
...
The principles that have operational content (as opposed to aspiration):
...
**Transparency:** AI systems should be explainable to the people affected by their decisions at the level of detail required by the use case and the regulations that apply. An AI that approves or denies a loan application must be able to explain the denial. An AI that recommends a video does not face the same requirement.
...
**Privacy:** AI systems should collect and process the minimum personal data required for the task, apply appropriate protections to that data, and respect the consent frameworks under which the data was collected.
...
This structure does not prevent all AI risk. It ensures that risk is visible, managed, and owned — which is the standard regulators and organizational leadership will hold the AI program to.
