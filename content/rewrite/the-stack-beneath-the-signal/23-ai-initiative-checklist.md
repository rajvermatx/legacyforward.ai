...
description: "A diagnostic checklist for evaluating enterprise AI initiatives before committing resources — the questions that surface hidden risks before they become expensive surprises."
...
Use it at the beginning of an AI initiative, when evaluating a vendor proposal, when reviewing a project plan, or any time an AI project appears to be moving faster than the groundwork beneath it.
...
Is there consent to use customer data for AI modeling? Are there data residency requirements that limit where it can be processed? Has legal or compliance reviewed the data use?
...
Building AI integrations on top of a system about to be replaced means doing the work twice.
...
For high-stakes decisions, AI should augment human judgment. Who makes the final call? Are they aware of and comfortable with this role?
...
If the AI system produces systematically wrong outputs — biased recommendations, incorrect classifications, flawed predictions — how will that be detected, and how quickly?
...
Not every AI initiative succeeds. If this one does not, what is the plan? Can the organization return to the previous process? Has the investment been sized appropriately for an outcome that may not arrive?

---

## How to Use This Checklist

Not every question needs a complete answer before an initiative begins. Some answers will emerge during the project. The goal is to identify which questions do not have answers yet — and to treat the most critical unanswered questions as explicit risks that need to be managed.

A project team that can honestly work through these questions is a team that understands what it is building and what it is building on top of. That understanding is the difference between AI initiatives that deliver on their promise and AI initiatives that deliver expensive lessons.
