---
title: "Why You Need to Understand IT Before You Touch AI"
slug: "prologue"
description: "AI doesn't land on a blank slate. It lands on decades of accumulated systems, decisions, and constraints. This book explains what's already there."
...
Almost always, it is the infrastructure underneath it. The systems that have been running for twenty, thirty, sometimes forty years. The data that lives in seven different places in seven different formats. The integration layer stitched together over a decade of mergers and quick fixes. The vendor contract that makes switching painful. The process nobody documented because the person who understood it retired in 2018.
...
Most books about AI in the enterprise assume you already understand the technology stack. They jump straight to machine learning models, vector databases, and agent frameworks, treating the underlying infrastructure as a given.

For many people — business leaders, product managers, career pivoters, consultants, and even technical people new to enterprise environments — the stack is not a given. It is a mystery. A slow-moving, highly political, surprisingly expensive mystery.

This book explains the mystery.

No code. No architecture diagrams requiring a computer science degree to read. This book explains enterprise technology the way you would explain it to a smart colleague who just joined the company and needs to understand why nothing works the way they expected.
...
**Part Three: The IT Sprawl Problem** gets into how things get complicated. Every organization accumulates technology — through acquisitions, shadow IT, good intentions, and deferred decisions. The landscape grows in ways no one fully planned. This section explains how sprawl happens and what it costs.
...
Every term is defined when it first appears. The glossary at the end collects them all in one place. If you hit a term you do not recognize, check the glossary before assuming the book skipped an explanation.

---

## Who This Is For

- Business leaders sponsoring AI initiatives who need to understand why progress is slower than expected
