...
That is what matters. Not when it was built. Whether you are trapped.
...
In most cases, the answer is: everything that depends on them stops working. And because legacy systems tend to be at the center of things, everything means a lot.

This is why enterprises do not simply replace legacy systems when something new comes along. Not because the people making the decisions are incapable of seeing that the old system is imperfect. But because replacing it requires a level of planning, risk management, and organizational alignment that is genuinely difficult — and because the cost of getting it wrong is very high.
