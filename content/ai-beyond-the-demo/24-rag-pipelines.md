...
- The ingestion pipeline: chunking, embedding, and indexing
- The retrieval pipeline: query embedding, similarity search, and context assembly
- The failure modes specific to RAG and how to address them
